...
<div class="baseform">
	...
	[registration]
			...
			Вы оставлять свои комментарии, просматривать скрытый текст и многое другое.
	...
	[registration]
		<tr>
			...
			<td>
				<input type="text" name="name" id='name' class="f_input" onblur="CheckLogin(); return false;" />
